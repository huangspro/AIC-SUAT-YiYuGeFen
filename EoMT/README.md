...
- Adapted the dataset parser for our semantic segmentation task(see [1]).
...
- Added some methods and members to load and precess the predict dataset. 
---
## Training Module
...
4. The check point now is only trained for 50 epochs, which maybe not enough for our task. More epochs of training will be implemented.
