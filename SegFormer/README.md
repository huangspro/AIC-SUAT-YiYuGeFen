...
> To train model, you should make sure that the 2 files above are put in model_Data/.During training, the best model weights will be put in logs/. Next time for continuing training, you should move the weights in logs/ to model_data/ by hand.
